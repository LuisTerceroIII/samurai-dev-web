...
const LandingView:React.FC<LandingProps> = ({title,paragraph,button,styles}): JSX.Element => {
    return (
        <div className={styles.grid}>
            ...
            <Button cssClass={button.cssClass} value={button.value} onClick={button.onClick} disable={button.disable}/>
        </div>
    );
};
